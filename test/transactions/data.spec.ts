...
describe('data', () => {
  ...
  test.each([
    [
      ...
      1,
      base64Decode(
        'DAEOfDELVTFkTjXX6NQIecrcVDMzucL6GfiwihJh+rt7SAAEAANpbnQA//////////8AA3N0cgMABnN0cmluZwAEYm9vbAEBAANiaW4CAAVhbGljZQAAAXSHboAAAAAAAAABhqA=',
      ),
    ],
    [
      [
      ...
      2,
      base64Decode(
        'CEkSIA58MQtVMWRONdfo1Ah5ytxUMzO5wvoZ+LCKEmH6u3tIGgQQoI0GIICAurvILigCggc5ChAKA2ludFD///////////8BCg0KA3N0cmoGc3RyaW5nCggKBGJvb2xYAQoMCgNiaW5iBWFsaWNl',
      ),
    ],
    [
      [
      ...
      1,
      base64Decode(
        'DAEOfDELVTFkTjXX6NQIecrcVDMzucL6GfiwihJh+rt7SAAEAANpbnQAAAAAAAAAAAAAA3N0cgMABnN0cmluZwAEYm9vbAEAAANiaW4CAAQBAgMEAAABdIdugAAAAAAAAAGGoA==',
      ),
    ],
    [
      [
      ...
      2,
      base64Decode(
        'CEkSIA58MQtVMWRONdfo1Ah5ytxUMzO5wvoZ+LCKEmH6u3tIGgQQoI0GIICAurvILigCggcvCgcKA2ludFAACg0KA3N0cmoGc3RyaW5nCggKBGJvb2xYAAoLCgNiaW5iBAECAwQ=',
      ),
    ],
    [
      [{ key: 'null', value: null }],
      2,
      base64Decode(
        'CEkSIA58MQtVMWRONdfo1Ah5ytxUMzO5wvoZ+LCKEmH6u3tIGgQQoI0GIICAurvILigCggcICgYKBG51bGw=',
      ),
    ],
    [
      [
      ...
      2,
      base64Decode(
        'CEkSIA58MQtVMWRONdfo1Ah5ytxUMzO5wvoZ+LCKEmH6u3tIGgQQoI0GIICAurvILigCggcXCgYKBG51bGwKDQoDc3RyagZzdHJpbmc=',
      ),
    ],
  ...
  test.each([
    ...
    [
      ...
      1,
      'The value of the "value" field can only be null in a version greater than 1.',
    ],
    [
      [
        {
          ...
          type: 'integer',
          value:
            '3PAZv9tgK1PX7dKR7b4kchq5qdpUS3G5sYT|3PJ6iR5X1PT2rZcNmbqByKuh7k8mtj5wVGw|3P3NVrhiyHBc4oUWNhtZRnJA5uLX9n39TK9|3PCobfdpn4djVBG1Z3Ubek79kKcEiWYjrDv',
        },
      ],
      1,
      'type "integer" does not match value',
    ],
    [
      [
        {
      ...
      1,
      'type "boolean" does not match value "false"(string)',
    ],
  ...
  it('Should not create data with negative fee', () => {
    expect(() => data({ ...dataMinimalParams, fee: -1 }, senderPk)).toThrowError(
